        ...
        <div class="nav-inner">
          <div class="logo">
            <a href="${siteUrl(`${landingFile}#home`)}" aria-label="Madhi Studio home">
              <img src="${siteUrl(document.documentElement.dataset.headerStyle === "alt" ? "assets/madhi-studio-logo-inverse.svg" : "assets/madhi-studio-logo-alt.svg")}" alt="Madhi Studio">
            </a>
          </div>
